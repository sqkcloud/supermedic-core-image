/*
 * Copyright (c) 2010-2023 Supermedic Team and other contributors.
 *
 ...
 */
package org.supermedic.core.util;
...
class EscapeCharsTest {
  ...
  class Html_Escaping_Tests {
    ...
    @ParameterizedTest
    @MethodSource("org.supermedic.core.util.EscapeCharsTest#htmlBasicEscapeData")
    void should_escape_basic_html_characters(String input, String expected) {
      assertEquals(expected, EscapeChars.forHTML(input));
    }

    @ParameterizedTest
    @MethodSource("org.supermedic.core.util.EscapeCharsTest#htmlComplexEscapeData")
    void should_handle_complex_html_escaping_scenarios(String input, String expected) {
      assertEquals(expected, EscapeChars.forHTML(input));
    }

    @ParameterizedTest
    @MethodSource("org.supermedic.core.util.EscapeCharsTest#htmlAccentedCharData")
    void should_escape_accented_and_special_characters(String input, String expected) {
      assertEquals(expected, EscapeChars.forHTML(input));
    }

    @ParameterizedTest
    @MethodSource("org.supermedic.core.util.EscapeCharsTest#htmlUnicodeQuoteData")
    void should_handle_unicode_quotation_marks(String input, String expected) {
      assertEquals(expected, EscapeChars.forHTML(input));
    }

    @ParameterizedTest
    @MethodSource("org.supermedic.core.util.EscapeCharsTest#htmlMathSymbolData")
    void should_handle_mathematical_and_greek_symbols(String input, String expected) {
      assertEquals(expected, EscapeChars.forHTML(input));
    }

    @ParameterizedTest
    @MethodSource("org.supermedic.core.util.EscapeCharsTest#safeCharacterData")
  ...
  class Xml_Escaping_Tests {
    ...
    @ParameterizedTest
    @MethodSource("org.supermedic.core.util.EscapeCharsTest#xmlBasicEscapeData")
  ...
  class Url_Ampersand_Tests {
    ...
    @ParameterizedTest
    @MethodSource("org.supermedic.core.util.EscapeCharsTest#urlAmpersandEscapeData")
  ...
  class Tag_Disabling_Tests {
    ...
    @ParameterizedTest
    @MethodSource("org.supermedic.core.util.EscapeCharsTest#tagDisableEscapeData")
